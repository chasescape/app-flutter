/// AI request core config.
///
/// Copied from `.agents/skills/image-to-ai-service/templates/ai_request_config.dart`.
/// Keep request/response logic consistent with OpenAI-compatible APIs.
