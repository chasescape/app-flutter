...
class Unshaved408Interface {
  Unshaved408Interface._();

  static Unshaved408Interface? _instance;

  factory Unshaved408Interface() {
    _instance ??= Unshaved408Interface._();
    return _instance!;
  }

  // A面登录态入口页面 确保是A面的home页面
  String lightHome = Routes.home;
  String loginPage = Routes.login;
  ...
  void setRunEnv({
    ...
    // TODO A面配置
    final config = Aquaria255AppEnv();
    config.env = runEnv == 'prod' ? Wreaking868AppEnvType.product : Wreaking868AppEnvType.test;
