...
class AuthService {
  ...
  Future<Map<String, dynamic>> logout() async {
    final res = await NetworkService.ins.post('/api_prod/v0/stock_minimum_value/get');
    await AppConfigService.clearAuth();
    return res;
  }

  Future<Map<String, dynamic>> deleteAccount() async {
    final res = await NetworkService.ins.post('/api_prod/res/deviceinfo_max_int/patch');
    return res;
  }
}
