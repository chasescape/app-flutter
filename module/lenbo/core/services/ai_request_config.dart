/// AI request core configuration.
///
/// This keeps the OpenAI-compatible request and response handling in one place
/// so feature services can share the same stable protocol logic.
class AiRequestConfig {
      ...
      'messages': [
        {'role': 'system', 'content': systemPrompt},
        {
          ...
          'content': [
            ...
            {
              'type': 'image_url',
              'image_url': {'url': buildImageUrl(imageBase64)},
            },
          ],
        },
      ],
  ...
  static String buildImageUrl(String base64Data, {String mimeType = 'image/jpeg'}) {
