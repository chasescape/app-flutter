/// AI request core config copied from the project skill template.
///
/// The request body, headers, response extraction, markdown cleanup, and image
/// URL formatting intentionally follow the fixed template logic.
