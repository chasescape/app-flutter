...
import 'app/network/auth_service.dart';
import 'app/services/coin_store.dart';
import 'app/services/advice_store.dart';
...
class LightHandle {
  ...
  static Future<void> _initDataFromStorage() async {
    ...
    await CoinStore.loadFromStorage();
    await AdviceStore.loadFromStorage();
  ...
  static Future<void> login() async {
    await AuthService.ins.signInWithDevice();
  }

  /// A面删除账号操作 (函数名具体定义)
  static Future<void> deleteAccount() async {
    await AuthService.ins.deleteAccount();
    clearAllData();
  }
