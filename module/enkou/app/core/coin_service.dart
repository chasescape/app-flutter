...
class CoinService {
  ...
  Future<List<Map<String, dynamic>>> getGoodsList({
    ...
    // 发送加密请求并解密响应
    final decrypted = await _sendEncryptedRequest('/appApi/game_first_array/delete', body);
  ...
  Future<Map<String, dynamic>> createRechargeOrder({
    ...
    // 发送加密请求并解密响应
    final decrypted = await _sendEncryptedRequest('/appApi/v1/report_top_result/post', body);
